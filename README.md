...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/1st_Place-FinAI_2025-FFB300?style=for-the-badge&logoColor=white" alt="1st Place FinAI 2025">
</p>
...
I work on **resource-efficient AI and NLP systems that actually work in the real
world**: fine-tuning LLMs and building production RAG pipelines. Big models are easy
to demo and expensive to run. I care about the version that ships: small enough to
afford, fast enough to use, and accurate enough to trust.
...
|---|---|---|
| **[FinVerse Agent](https://ieeexplore.ieee.org/document/11261453)** | 15 LoRA adapters on one 4-bit quantized LLaMA-3.1-8B, with a Planner–Executor–Verifier routing loop. | **93.07%** on CFA Level I, above GPT-4o |
...
| **TMG / The Spine** | Multilingual property assistant in Arabic, English, Spanish and French. | Shipped to production |
...
![Quantization](https://img.shields.io/badge/Quantization-7E57C2?style=flat-square)
